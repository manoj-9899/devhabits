...
- **`README.md`**: The entry point. Explains _what_ the project is, _why_ it exists, and _how_ to use it.
...
2.  **Use the Imperative Mood:** "fix bug" not "fixed bug" or "fixes bug". (Think: "If applied, this commit will _fix bug_").
